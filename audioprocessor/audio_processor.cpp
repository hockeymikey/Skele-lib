...
CAP::AudioProcessor::AudioProcessor(std::unique_ptr<AbstractCircularQueue> circularQueue_): circularQueue(std::move(circularQueue_)), circularQueueMutex(new std::mutex()), bundlesMutex(new std::mutex()) {
